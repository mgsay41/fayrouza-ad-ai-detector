...
export const ar = {
  ...
  form: {
    ...
    infoBox: {
      ...
      note: 'ملاحظة: قم بتعيين VITE_API_URL و VITE_MODERATION_API_KEY للاتصال بخادم المراجعة.',
    },
  ...
  history: {
    ...
    clearAllTitle: 'مسح السجل',
    clearAllDescription: 'سيتم حذف جميع سجلات الإرسال نهائيًا. لا يمكن التراجع عن هذا الإجراء.',
    storageFull: 'التخزين ممتلئ',
    storageFullDesc: 'تعذر حفظ السجل — مساحة التخزين في المتصفح ممتلئة. فكر في مسح الإدخالات القديمة.',
  ...
  // Test cases panel
  testCases: {
    sectionTitle: 'حالات الاختبار',
    sectionSubtitle: 'انقر على أي حالة لملء النموذج تلقائياً',
    expected: {
      approve: 'موافقة',
      reject: 'رفض',
      review: 'مراجعة',
