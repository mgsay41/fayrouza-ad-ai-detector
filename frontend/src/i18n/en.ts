...
export const en = {
  ...
  form: {
    ...
    infoBox: {
      ...
      note: 'Note: Set VITE_API_URL and VITE_MODERATION_API_KEY to connect to the moderation backend.',
    },
  ...
  history: {
    ...
    clearAllDescription: 'This will permanently delete all submission history. This action cannot be undone.',
    storageFull: 'Storage Full',
    storageFullDesc: 'Could not save history — browser storage is full. Consider clearing old entries.',
  ...
  testCases: {
    ...
    sectionSubtitle: 'Click any case to instantly pre-fill the form',
    expected: {
      approve: 'Approve',
      reject: 'Reject',
      review: 'Review',
